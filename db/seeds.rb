...
vaisselle = Task.create!(
  name: "Faire la vaisselle",
  description: "💦 Fais-la tremper à l'avance pour gagner du temps",
  recurrence: "daily",
  auto_assigned: false,
...
aspirateur = Task.create!(
  name: "Passer l'aspirateur",
  description: "🔌 Un peu de cannelle sur le sol pour parfumer ton appart'",
  recurrence: "weekly",
  auto_assigned: true, 
...
poussiere = Task.create!(
  name: "Enlever les poussières",
  description: "💧 Avec un chiffon humide, c'est le top !",
  recurrence: "weekly",
  auto_assigned: true,
...
vitre = Task.create!(
  ...
  description: "🪟 Passe toujours la raclette dans le même sens",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 4)
...
serpillere = Task.create!(
  name: "Passer la serpillère",
  description: "🪑 Enlève tous les meubles avant",
  recurrence: "weekly",
  auto_assigned: true, 
  default_difficulty: 3)
...
sortir_poubelle = Task.create!(
  name: "Sortir la poubelle",
  description: "♻️ Pense au tri",
  recurrence: "daily",
  auto_assigned: false,
...
lessive = Task.create!(
  ...
  description: "🍋 Utilise du citron pour garder le blanc",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 1)
...
toilettes = Task.create!(
  name: "Laver les toilettes",
  description: "🧪 Bicarbonate + Vinaigre Blanc",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 3)
...
salle_de_bain = Task.create!(
  name: "Laver la salle de bain",
  description: "🍋 Du citron sur la robinetterie",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 4)
...
linge = Task.create!(
  ...
  description: "👕 On veut un maximum de cintres !",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 2)
...
courses = Task.create!(
  ...
  description: "🛵 Interdit de se les faire livrer",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 3)
...
plantes = Task.create!(
  ...
  description: "🌱 Un petit sytème de goutte à goutte ?",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 1)
...
verre = Task.create!(
  name: "Vider le verre",
  description: "👩‍❤️‍👨 Avec un coloc', c'est plus simple",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 3)
...
cuisiner = Task.create!(
  name: "Cuisiner",
  description: "🍳 Fais-en un peu plus pour le lendemain midi",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 2)
...
lave_vaisselle = Task.create!(
  name: "Vider le lave-vaisselle",
  description: "⚠️ Évite le caoutchouc et le silicone",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 2)
...
frigo = Task.create!(
  ...
  description: "🧴 Combo : Vinaigre blanc avec du citron",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 4)
...
balai = Task.create!(
  ...
  description: "🧹 Accorde-toi avec celui/celle qui passe la serpillère",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 2)
...
animal = Task.create!(
  name: "Sortir l'animal",
  description: "🦴 N'oublie pas les friandises",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 2)
...
four = Task.create!(
  ...
  description: "🥘 Les plaques au lave-vaisselle",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 4)
...
placard = Task.create!(
  name: "Nettoyer les placards",
  description: "💧 Combo : eau chaude + liquide vaisselle",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 3)
...
micro_onde = Task.create!(
  name: "Nettoyer le micro-ondes",
  description: "🍋 Fais chauffer un bol d'eau citronnée pendant 2mn avant",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 2)
...
nettoyer_table = Task.create!(
  name: "Nettoyer la table",
  description: "🧽 Un petit chiffon humidifié",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 1)
...
papier = Task.create!(
  name: "S'occuper des papiers",
  description: "📝 Ah...l'administratif !",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 2)
...
piece_commune = Task.create!(
  name: "Ranger la pièce commune",
  description: "🛋 Histoire de circuler détente",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 2)
...
cendrier = Task.create!(
  name: "Vider le cendrier",
  description: "🧯 Un peu d'eau au cas où",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 1)
...
bouilloire = Task.create!(
  name: "Détartrer la bouilloire",
  description: "💦 Combo : eau + acide citrique",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 1)
...
café = Task.create!(
  name: "Laver la machine à café",
  description: "☕️ Vinaigre à balle !",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 1)
...
evier = Task.create!(
  name: "Laver l'évier",
  description: "💪🏻 Toujours et encore le bicarbonate de soude",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 1)
...
mettre_table = Task.create!(
  name: "Mettre la table",
  description: "🍴 Couteau à droite, fourchette à gauche",
  recurrence: "daily",
  auto_assigned: false,
  default_difficulty: 1)
...
laver_poubelle = Task.create!(
  name: "Laver la poubelle",
  description: "🧂 Mets un peu de sel au fond",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 2)
...
chat = Task.create!(
  name: "Changer la litière du chat",
  description: "😳 Bicarbonate de soude pour éviter les odeurs",
  recurrence: "weekly",
  auto_assigned: true,
  default_difficulty: 2)
...
battre_tapis = Task.create!(
  name: "Battre le tapis",
  description: "👟 Enlève tes chaussures la prochaine fois",
  recurrence: "daily",
  auto_assigned: true,
  default_difficulty: 1)
